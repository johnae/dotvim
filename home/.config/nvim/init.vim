...
silent !mkdir -p ~/.config/nvim/after
...
let neo_bundle_readme=expand('~/.config/nvim/bundle/neobundle.vim/README.md')
...
nnoremap <c-M> :<c-u>Unite -no-split -start-insert buffer<cr>
